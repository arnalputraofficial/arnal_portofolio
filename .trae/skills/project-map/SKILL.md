...
| `AdminDashboard.tsx` | `/admin` | Panel bertab: `Content` (`ContentEditor`), `Entries` (`EntriesPanel`), `Charts` (`ChartsPanel`), `Inbox` (`MessagesPanel`), `Sessions`, `Revisions` (`HistoryPanel`), `Account` (`PasswordForm`) |
